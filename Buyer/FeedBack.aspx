<%@ page title="" language="C#" masterpagefile="~/Buyer/MasterPage.master" autoeventwireup="true" inherits="Buyer_Default, App_Web_r2nsiqcm" %>
        ...
        <table style="margin: 10px 10px 10px 10px">
            <tr>
                ...
                <asp:Button ID="Button1" runat="server" Text="Send..." 
                        style="position:relative;" CssClass="submit_button" onclick="Button1_Click" ValidationGroup="feedback"/>
                </td>
            </tr>
            <tr>
