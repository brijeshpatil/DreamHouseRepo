<%@ page title="" language="C#" masterpagefile="~/Buyer/MasterPage.master" autoeventwireup="true" inherits="Buyer_Default, App_Web_wseqcx24" %>
        ...
        <table width="450px" style="margin: 10px 10px 10px 10px">
            ...
            <tr>
                <td colspan="5" align="center">
                    <asp:Button ID="Button1" runat="server" Text="SEARCH" CssClass="submit_button" style="position:relative;" onclick="Button1_Click" />
                </td>
            </tr>
        </table>
        </div>
