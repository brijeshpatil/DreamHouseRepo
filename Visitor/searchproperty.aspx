<%@ page title="" language="C#" masterpagefile="~/Visitor/MasterPage.master" autoeventwireup="true" inherits="Buyer_Default, App_Web_hhcfsog4" %>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <asp:CompareValidator ID="CompareValidator5" runat="server" ErrorMessage="Enter only Numeric Value"
                                    ControlToValidate="TextBox1" Operator="DataTypeCheck" Type="Double" ValidationGroup="Res"
                                    SetFocusOnError="true" />
                                <asp:RequiredFieldValidator ValidationGroup="Res" ID="RequiredFieldValidator6" runat="server"
                                    ControlToValidate="TextBox2" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Max Price"
                                    SetFocusOnError="true" />
                                <asp:CompareValidator ValidationGroup="Res" ID="CompareValidator6" runat="server"
                                    ErrorMessage="Enter only Numeric Value" ControlToValidate="TextBox2" Operator="DataTypeCheck"
                        ...
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Button ID="Button1" runat="server" Text="SEARCH" CssClass="submit_button" ValidationGroup="Res"
                            ...
                            <ItemTemplate>
                                <ul class="listing">
                                    <li class="one_third" style="width: 310px;"><a href="#">
                                        ...
                                        <span class="price">Rs.<asp:Label ID="Label8" runat="server" Text='<%#bind("p_range") %>' /></span>
                                        <ul class="listing-info">
                                            <li class="listing-info-beds">
                                                <asp:Label ID="Label17" runat="server" Text='<%#bind("bhk") %>' /></li>
                                            <li class="listing-info-baths">
                                                <asp:Label ID="Label18" runat="server" Text='<%#bind("bathroom") %>' />
                                                Baths </li>
                                            <li class="listing-info-area">
                                                <asp:Label ID="Label19" runat="server" Text='<%#bind("covered_area") %>' />
                                            </li>
                                        </ul>
                                        <asp:LinkButton ID="LinkButton3" runat="server" Style="float: left; color: Black;"
                                            CommandName="book" CommandArgument='<%#bind("property_id") %>'>Book</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton4" runat="server" Style="float: right; color: Black;"
                                            CommandName="moreinfo">More Info</asp:LinkButton>
                                    </a></li>
                                </ul>
                            </ItemTemplate>
                        </asp:DataList>
                        <div align="center">
                            <asp:Button ID="btnfirst1" runat="server" Text="<<" OnClick="btnfirst1_Click" Visible="false" />
                            <asp:Button ID="btnprev1" runat="server" Text="<" OnClick="btnprev1_Click" Visible="false" />
                            <asp:Button ID="btnnext1" runat="server" Text=">" OnClick="btnnext1_Click" Visible="false" />
                            <asp:Button ID="btnlast1" runat="server" Text=">>" OnClick="btnlast1_Click" Visible="false" />
                        </div>
                    </div>
                </div>
            </ContentTemplate>
        </cc1:TabPanel>
        <cc1:TabPanel runat="server" HeaderText="Commertial" ID="TabPanel2" TabIndex="1">
            <ContentTemplate>
                <div style="width: 100%; margin: 10px 10px 10px 10px;">
                    <table width="100%">
                        <tr>
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox5"
                                    ValidationGroup="com" ForeColor="Red" Display="Dynamic" ErrorMessage="Enter Min Price"
                                    SetFocusOnError="true" />
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Enter only Numeric Value"
                                    ValidationGroup="com" ControlToValidate="TextBox5" Operator="DataTypeCheck" Type="Double"
                                    SetFocusOnError="true" /><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                                        ValidationGroup="com" runat="server" ControlToValidate="TextBox6" ForeColor="Red"
                                        Display="Dynamic" ErrorMessage="Enter Max Price" SetFocusOnError="true" /><asp:CompareValidator
                                            ID="CompareValidator2" runat="server" ValidationGroup="com" ErrorMessage="Enter only Numeric Value"
                        ...
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Button ID="Button2" runat="server" Text="SEARCH" CssClass="submit_button" ValidationGroup="com" Style="position: relative;"
                ...
                <div style="margin-top: 10px;">
                    <div id="Div1" style="margin-top: 0%;">
                            ...
                            <ItemTemplate>
                                <ul class="listing">
                                    <li class="one_third" style="width: 310px;"><a href="#">
                                        ...
                                        <ul class="listing-info">
                                            <li class="listing-info-beds">
                                                <asp:Label ID="Label13" runat="server" Text='<%#bind("bhk") %>' /></li>
                                            <li class="listing-info-baths">
                                                <asp:Label ID="Label14" runat="server" Text='<%#bind("bathroom") %>' />
                                                Baths </li>
                                            <li class="listing-info-area">
                                                <asp:Label ID="Label15" runat="server" Text='<%#bind("covered_area") %>' />
                                            </li>
                                        </ul>
                                        <asp:LinkButton ID="LinkButton2" runat="server" Style="float: left; color: Black;"
                                            CommandName="book" CommandArgument='<%#bind("property_id") %>'>Book</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton5" runat="server" Style="float: right; color: Black;"
                                            CommandName="moreinfo">More Info</asp:LinkButton>
                                    </a></li>
                                </ul>
                            </ItemTemplate>
                        ...
                        <div align="center">
                            <asp:Button ID="btnfirst2" runat="server" Text="<<" OnClick="btnfirst2_Click" Visible="false" />
                            <asp:Button ID="btnprev2" runat="server" Text="<" OnClick="btnprev2_Click" Visible="false" />
                            <asp:Button ID="btnnext2" runat="server" Text=">" OnClick="btnnext2_Click" Visible="false" />
                            <asp:Button ID="btnlast2" runat="server" Text=">>" OnClick="btnlast2_Click" Visible="false" />
                        </div>
                    </div>
                </div>
            </ContentTemplate>
        </cc1:TabPanel>
        <cc1:TabPanel runat="server" HeaderText="Luxurious" ID="TabPanel3" TabIndex="2">
            <ContentTemplate>
                <div style="width: 100%; margin: 10px 10px 10px 10px;">
                    <table width="100%">
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3"
                                    ...
                                    <asp:CompareValidator
                                        ID="CompareValidator3" runat="server" ErrorMessage="Enter only Numeric Value"
                                        ControlToValidate="TextBox3" Operator="DataTypeCheck" Type="Double" SetFocusOnError="true" ValidationGroup="Lux"/>
                                        
                                        <asp:RequiredFieldValidator
                                            ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4" ForeColor="Red"
                                            Display="Dynamic" ErrorMessage="Enter Max Price" SetFocusOnError="true" ValidationGroup="Lux"/>
                                            
                                            <asp:CompareValidator
                                                ID="CompareValidator4" runat="server" ValidationGroup="Lux" ErrorMessage="Enter only Numeric Value"
                                                ControlToValidate="TextBox4" Operator="DataTypeCheck" Type="Double" SetFocusOnError="true" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Button ID="Button3" runat="server" Text="SEARCH" CssClass="submit_button" ValidationGroup="Lux" Style="position: relative;"
                ...
                <div style="margin-top: 10px;">
                    <div id="Div2" style="margin-top: 0%;">
                            ...
                            <ItemTemplate>
                                <ul class="listing">
                                    <li class="one_third" style="width: 310px;"><a href="#">
                                        ...
                                        <ul class="listing-info">
                                            <li class="listing-info-beds">
                                                <asp:Label ID="Label9" runat="server" Text='<%#bind("bhk") %>' /></li>
                                            <li class="listing-info-baths">
                                                <asp:Label ID="Label10" runat="server" Text='<%#bind("bathroom") %>' />
                                                Baths </li>
                                            <li class="listing-info-area">
                                                <asp:Label ID="Label11" runat="server" Text='<%#bind("covered_area") %>' />
                                            </li>
                                        </ul>
                                        <asp:LinkButton ID="LinkButton1" runat="server" Style="float: left; color: Black;"
                                            CommandName="book" CommandArgument='<%#bind("property_id") %>'>Book</asp:LinkButton>
                                        <asp:LinkButton ID="LinkButton6" runat="server" Style="float: right; color: Black;"
                                            CommandName="moreinfo">More Info</asp:LinkButton>
                                    </a></li>
                                </ul>
                            </ItemTemplate>
                        ...
                        <div align="center">
                            <asp:Button ID="btnfirst" runat="server" Text="<<" OnClick="btnfirst_Click" Visible="false" />
                            <asp:Button ID="btnprev" runat="server" Text="<" OnClick="btnprev_Click" Visible="false" />
                            <asp:Button ID="btnnext" runat="server" Text=">" OnClick="btnnext_Click" Visible="false" />
                            <asp:Button ID="btnlast" runat="server" Text=">>" OnClick="btnlast_Click" Visible="false" />
                        </div>
                    </div>
                </div>
            </ContentTemplate>
...
<asp:Content ID="Content5" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <ul>
        ...
        <li class="active"><a href="searchproperty.aspx">Property</a></li>
