<%@ page title="" language="C#" masterpagefile="~/Visitor/MasterPage.master" autoeventwireup="true" inherits="Buyer_Default, App_Web_5p2nsvw4" %>
    ...
    <div class="MyTabStyle" style="width: 100%; margin-top: 5px">
        <table width="450px" style="margin: 10px 10px 10px 10px">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DropDownList1" runat="server" Width="200px" Height="29px" AutoPostBack="True"
                        OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" />
                </td>
                <td>
                    <asp:DropDownList ID="DropDownList2" runat="server" Width="200px" Height="29px" AutoPostBack="True"
...
<asp:Content ID="Content5" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <ul>
        ...
        <li class="active"><a href="searchagent.aspx">Agents</a></li>
